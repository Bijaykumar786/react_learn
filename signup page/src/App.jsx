...
const App = () => {
  return (
    ...
    <div className="signup-container">
      ...
      <p className="separator"><span>Create an account !!</span></p>
      ...
      <form action="#" className="signup-form">
        ...
        <InputField type="password" placeholder="Conform Password" icon="lock" />

        <input type="checkbox" /> <label htmlFor="term">I accept the <a href="#">term</a> & <a href="#">Privacy Policy</a>. </label>
